        ...
        builder: (context, setDialogState) {
          return AlertDialog(
            ...
            actions: [
              ...
              ElevatedButton(
                onPressed: () {
                  if (adminUsernameController.text == 'admin' && adminPasswordController.text == 'admin123') {
                            ...
                            SizedBox(
                              ...
                              child: ElevatedButton(
                                onPressed: () async {
                                  ...
                                  Student? student = await DatabaseHelper().getStudentByEmail(email);
                                  ...
                                  if (student != null && student.password == password) {
                                    if (mounted) {
                                      Navigator.push(
                                        context,
                                        MaterialPageRoute(
                                          builder: (context) => HomeScreen(fullName: student.fullName),
                                        ),
                                      );
                                    }
                                  } else {
